...
export const lstCollectionFields = [
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "true if the company is active and currently selected in Tally, false if the company is inactive or not currently selected in Tally",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                datatype: "boolean",
                description: "applicable only when isRevenue is true, if found true then group belongs to trading used for gross profit calculation",
            },
    ...
    },
    {
        ...
        fields: [
            ...
            { name: "ClosingBalance", datatype: "amount", description: "closing or ending or balance based on to date" },
            {
                name: "DebitTotals",
                datatype: "amount",
                description: "total debit amount of all vouchers passed during the period from and to date, negative denotes debit and vice-a-versa",
            },
            {
                name: "CreditTotals",
                datatype: "amount",
    ...
    },
    {
        ...
        fields: [
            ...
            { name: "Parent", datatype: "string" },
            {
                name: "FormalName",
                datatype: "string",
                description: "full name or formal name like Kilogram for name as kg, Litre for name as ltr, Piece for name as pcs",
            },
            ...
            { name: "AdditionalUnits", datatype: "string", description: "additional units if any" },
            {
                name: "Conversion",
                datatype: "string",
                description: 'conversion expression or multiplier to convert additional units to base units if applicable, example "1 Dozen = 12 Pcs" or "1 Quintal = 100 Kgs"',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                description: "name field of Unit collection under which item is nested which is set as alternate or additional unit",
            },
            ...
            },
            {
                name: "OpeningValue",
                datatype: "amount",
                description: "opening or begning value of stock item as on from date, negative denotes debit and to be treated as positive and vice-a-versa",
            },
            {
                name: "ClosingValue",
                datatype: "amount",
                description: "closing or ending value of stock item as on to date, negative denotes debit and to be treated as positive and vice-a-versa",
            },
            ...
            { name: "ClosingRate", datatype: "rate", description: "closing or ending rate as on to date" },
            {
                name: "CostingMethod",
                datatype: "string",
                description: "method of valuation of opening or closing stock which can be Avg. Cost (Average Cost), FIFO (First in First Out), Std. Cost (Standard Cost), At Zero Cost, Monthly Avg. Cost",
            },
            {
                name: "InwardQuantity",
                datatype: "quantity",
                description: "total inward quantity purchase or sales return or stock transfer during the period from and to date",
            },
            {
                name: "OutwardQuantity",
                datatype: "quantity",
                description: "total outward quantity sales or purchase return or stock transfer during the period from and to date, it will be in negative which denotes outflow to be treated as positive and vice-a-versa",
            },
            {
                name: "InwardValue",
                datatype: "amount",
                description: "total inward value of purchase or sales return or stock transfer during the period from and to date, negative denotes debit and positive credit",
            },
            {
                name: "OutwardValue",
                datatype: "amount",
                description: "total outward value of sales or purchase return or stock transfer during the period from and to date, positive denotes credit and negative debit",
            },
        ],
    },
    {
